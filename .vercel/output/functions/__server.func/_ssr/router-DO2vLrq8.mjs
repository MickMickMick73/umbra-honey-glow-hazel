...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DO2vLrq8.js
var router_DO2vLrq8_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Hold the railhead. A frontier tower defense — seven emplacements, raiders on the line, and cinematic set pieces as the dust thickens."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Dk-JqjAl.mjs");
...
//#endregion
export { getRouter, router_DO2vLrq8_exports as t };
